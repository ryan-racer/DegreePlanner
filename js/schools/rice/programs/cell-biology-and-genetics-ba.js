export default {
  id: 'cell-biology-and-genetics-ba',
  name: 'Biosciences (Cell Biology and Genetics Concentration)',
  degree: 'BA',
  kind: 'major',
  school: 'Natural Sciences',
  url: 'https://ga.rice.edu/programs-study/departments-programs/natural-sciences/biosciences/cell-biology-and-genetics-ba/',
  hours: 60,
  notes: [
    ...
    },
    {
      ...
      requirements: [
        ...
        { type: 'course', name: 'Core Laboratory Course', options: ['BIOS 211'] },
        {
          ...
          count: 3,
          from: [
            'BIOE 342', 'BIOS 308', 'BIOS 310', 'BIOS 311', 'BIOS 313', 'BIOS 314', 'BIOS 315', 'BIOS 318',
            'BIOS 324', 'BIOS 393',
          ],
