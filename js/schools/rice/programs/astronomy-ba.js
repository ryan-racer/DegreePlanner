export default {
  ...
  url: 'https://ga.rice.edu/programs-study/departments-programs/natural-sciences/physics-astronomy/astronomy-ba/',
  hours: 52,
  notes: [
    'ASTR 400 must be taken for 2 semesters (2 credit hours total).',
    'Credit for PHYS 125, PHYS 126, PHYS 141, or PHYS 142 is not eligible for the Astronomy major.',
  ...
  requirements: [
    { type: 'group', name: 'Core Requirements', requirements: [
      ...
      { type: 'all', name: 'Physics Courses', items: ['PHYS 201', 'PHYS 202', 'PHYS 231', 'PHYS 301', 'PHYS 302'] },
      { type: 'all', name: 'Astronomy Courses', items: ['ASTR 229', 'ASTR 230', 'ASTR 350', 'ASTR 360', 'ASTR 400'] },
      { type: 'choose', name: 'Advanced Astrophysics Elective', count: 1,
        from: ['ASTR 408', 'ASTR 451', 'ASTR 452', 'ASTR 470', 'PHYS 413', 'PHYS 480'] },
    ]},
  ],
};
