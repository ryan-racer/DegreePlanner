const AI_SYSTEMS = [
  'COMP 330', 'DSCI 302', 'ELEC 383', 'ELEC 384', 'ELEC 403', 'ELEC 406', 'ELEC 430', 'ELEC 431', 'ELEC 434', 'ELEC 435',
  'ELEC 436', 'MECH 420', 'ELEC 437', 'ELEC 439', 'ELEC 440', 'COMP 440', 'ELEC 445', 'ELEC 447', 'COMP 447', 'ELEC 448',
  'ELEC 475', 'ELEC 478', 'ELEC 482', 'ELEC 498', 'COMP 498', 'MECH 498', 'MECH 488', 'STAT 413',
];
const COMPUTER_ENG = [
  'COMP 321', 'COMP 382', 'COMP 430', 'COMP 432', 'ELEC 328', 'ELEC 410', 'COMP 436', 'ELEC 411', 'ELEC 414', 'ELEC 415',
  'ELEC 420', 'ELEC 421', 'COMP 421', 'ELEC 422', 'ELEC 423', 'ELEC 424', 'COMP 424', 'ELEC 425', 'COMP 425', 'ELEC 426',
  'ELEC 428', 'ELEC 429', 'COMP 429', 'ELEC 434', 'ELEC 437', 'ELEC 450', 'COMP 450', 'MECH 450',
];
const NEUROENG = [
  ...
  requirements: [
    { type: 'group', name: 'Core Requirements', requirements: [
      { type: 'group', name: 'Mathematics and Science Courses', requirements: [
        ...
        { type: 'choose', name: 'Multivariable Calculus', count: 1, from: ['MATH 212', 'MATH 222', 'MATH 232'] },
        { type: 'choose', name: 'Linear Algebra', count: 1, from: ['CMOR 302', 'CMOR 303', 'MATH 221', 'MATH 355', 'MATH 354'] },
        ...
        { type: 'hours', name: 'Approved Electives in Mathematics and Science', hours: 3, from: [
          'BIOS 201', 'BIOS 101', 'CMOR 304', 'CMOR 360', 'CHEM 121', 'CHEM 111', 'CHEM 122', 'CHEM 112',
    ...
    { type: 'any', name: 'Area of Specialization', options: [
      { type: 'group', name: 'AI & Systems', requirements: [
        { type: 'choose', name: 'AI & Systems Courses', count: 3, from: AI_SYSTEMS },
