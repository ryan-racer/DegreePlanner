export default {
  id: 'integrative-biology-bs',
  name: 'Biosciences (Integrative Biology Concentration)',
  degree: 'BS',
  kind: 'major',
  school: 'Natural Sciences',
  url: 'https://ga.rice.edu/programs-study/departments-programs/natural-sciences/biosciences/integrative-biology-bs/',
  hours: 69,
  notes: [
  ...
  requirements: [
    ...
    {
      type: 'group',
      name: 'Major Concentration in Integrative Biology',
      requirements: [
        ...
        { type: 'all', name: 'Lecture Courses', items: ['BIOS 301', 'BIOS 332', 'BIOS 334', 'BIOS 341'] },
        {
          type: 'choose',
          name: 'Capstone Requirement',
          count: 1,
          from: [
            'BIOS 405', 'BIOS 410', 'BIOS 420', 'BIOS 423', 'BIOS 424', 'BIOS 425', 'BIOS 431', 'BIOS 441',
            'BIOS 442', 'BIOS 443', 'BIOS 444', 'BIOS 447', 'BIOS 449', 'BIOS 450', 'BIOS 460', 'BIOS 470',
            'BIOS 481', 'BIOS 482',
          ],
        ...
        {
          type: 'choose',
          name: 'Elective Lecture Course in Ecology and Evolutionary Biology',
          count: 1,
          from: [
        ...
        {
          type: 'choose',
          name: 'Elective Lecture Course in Biochemistry and Cell Biology',
          count: 1,
          from: [
            'BIOE 302', 'BIOE 464', 'BIOS 300', 'BIOS 302', 'BIOS 340', 'BIOS 344', 'BIOS 352', 'BIOS 353',
            'BIOS 363', 'BIOS 368', 'BIOS 372', 'BIOS 385', 'BIOS 390', 'BIOS 405', 'BIOS 410', 'BIOS 420',
            'BIOS 424', 'BIOS 425', 'BIOS 441', 'BIOS 442', 'BIOS 443', 'BIOS 444', 'BIOS 447', 'BIOS 449',
            'BIOS 450', 'BIOS 460', 'BIOS 470', 'BIOS 481', 'BIOS 482', 'EEPS 439', 'NEUR 380',
          ],
        },
        { type: 'all', name: 'Core Laboratory Courses', items: ['BIOS 211', 'BIOS 213'] },
        {
          type: 'choose',
          name: 'Elective Laboratory Course',
          count: 1,
          from: [
            'BIOS 308', 'BIOS 311', 'BIOS 313', 'BIOS 314', 'BIOS 315', 'BIOS 316', 'BIOS 317', 'BIOS 318',
            'BIOS 319', 'BIOS 320', 'BIOS 322', 'BIOS 323', 'BIOS 324', 'BIOS 327', 'BIOS 330', 'BIOS 337',
            'BIOS 339', 'BIOS 393',
          ],
        },
        {
