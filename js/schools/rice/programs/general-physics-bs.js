export default {
  id: 'general-physics-bs',
  name: 'Physics (General Physics Concentration)',
  degree: 'BS',
  kind: 'major',
  school: 'Natural Sciences',
  url: 'https://ga.rice.edu/programs-study/departments-programs/natural-sciences/physics-astronomy/general-physics-bs/',
  hours: 64,
  notes: [
  ...
  requirements: [
    ...
    { type: 'group', name: 'Major Concentration in General Physics', requirements: [
      { type: 'all', name: 'Physics Courses', items: ['PHYS 302', 'PHYS 312', 'PHYS 332', 'PHYS 425'] },
      { type: 'choose', name: 'Physics Electives', count: 2, from: ['PHYS 355', 'PHYS 411', 'PHYS 412', 'PHYS 413', 'PHYS 416', 'PHYS 480'] },
      { type: 'course', name: 'Partial Differential Equations', options: ['MATH 381', 'CMOR 304'] },
      { type: 'course', name: 'Complex Analysis or Linear Algebra', options: ['MATH 382', 'CMOR 302', 'CMOR 303', 'MATH 354', 'MATH 355'] },
    ]},
  ],
};
