export default {
  ...
  name: 'Physics (Applied Physics Concentration)',
  degree: 'BS',
  kind: 'major',
  school: 'Natural Sciences',
  url: 'https://ga.rice.edu/programs-study/departments-programs/natural-sciences/physics-astronomy/applied-physics-bs/',
  hours: 68,
  notes: [
    ...
    'PHYS 412 may be replaced by an approved substitute in applied physics.',
  ...
  requirements: [
    ...
    { type: 'group', name: 'Major Concentration in Applied Physics', requirements: [
      { type: 'all', name: 'Physics Courses', items: ['PHYS 302', ['PHYS 312', 'ELEC 361'], 'PHYS 332', 'ELEC 364', 'PHYS 412', 'PHYS 425'] },
      { type: 'any', name: 'Circuits and Signals', options: [
        { type: 'all', name: 'ELEC 242 and ELEC 244', items: ['ELEC 242', 'ELEC 244'] },
        { type: 'course', name: 'ELEC 243', options: ['ELEC 243'] },
      ]},
      { type: 'course', name: 'Physical Electronics', options: ['ELEC 305'] },
