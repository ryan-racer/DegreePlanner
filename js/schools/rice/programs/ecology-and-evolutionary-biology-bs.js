export default {
  id: 'ecology-and-evolutionary-biology-bs',
  name: 'Biosciences (Ecology and Evolutionary Biology Concentration)',
  degree: 'BS',
  kind: 'major',
  school: 'Natural Sciences',
  url: 'https://ga.rice.edu/programs-study/departments-programs/natural-sciences/biosciences/ecology-and-evolutionary-biology-bs/',
  hours: 69,
  notes: [
    ...
    },
    {
      ...
      requirements: [
        ...
        { type: 'course', name: 'Core Laboratory Course', options: ['BIOS 213'] },
        {
          ...
          count: 2,
          from: [
            'BIOS 211', 'BIOS 316', 'BIOS 317', 'BIOS 319', 'BIOS 320', 'BIOS 322', 'BIOS 323', 'BIOS 327',
            'BIOS 330', 'BIOS 337', 'BIOS 339', 'BIOS 393',
          ],
        },
        {
          type: 'hours',
