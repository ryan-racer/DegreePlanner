export default {
  ...
  url: 'https://ga.rice.edu/programs-study/departments-programs/natural-sciences/biosciences/biochemistry-bs/',
  hours: 70,
  notes: [
    ...
    },
    {
      ...
      requirements: [
        ...
        { type: 'all', name: 'Core Laboratory Courses', items: ['BIOS 211', 'BIOS 311'] },
        {
          ...
          count: 1,
          from: ['BIOE 342', 'BIOS 308', 'BIOS 313', 'BIOS 314', 'BIOS 315', 'BIOS 318', 'BIOS 393'],
        },
        {
          type: 'hours',
