export default {
  id: 'environmental-science-ba-earth-concentration',
  name: 'Environmental Science (Earth Science Concentration)',
  degree: 'BA',
  kind: 'major',
  school: 'Natural Sciences',
  url: 'https://ga.rice.edu/programs-study/departments-programs/natural-sciences/environmental-science/environmental-science-ba-earth-concentration/',
  hours: 66,
  notes: [
  ...
  requirements: [
      ...
      requirements: [
        ...
        },
        {
          ...
          from: [
            ...
            'BIOS 327', 'BIOS 330', 'BIOS 337', 'BIOS 339', 'EEPS 103', 'EEPS 309', 'EEPS 334', 'EEPS 390',
            'EEPS 391',
          ],
    ...
    {
      type: 'group',
      name: 'Major Concentration in Earth Science',
      requirements: [
        { type: 'choose', name: 'Core Requirements', count: 2, from: ['EEPS 220', 'EEPS 322', 'EEPS 323'] },
        {
          type: 'choose',
          name: 'Elective Requirement',
          count: 1,
          from: [
            'EEPS 309', 'EEPS 322', 'EEPS 323', 'EEPS 415', 'EEPS 417', 'EEPS 420', 'EEPS 426', 'EEPS 427',
            'EEPS 429', 'EEPS 432', 'EEPS 433', 'EEPS 434', 'EEPS 435', 'EEPS 436', 'EEPS 437', 'EEPS 439',
            'EEPS 440', 'EEPS 467',
            { dept: 'EEPS', min: 300, exclude: ['EEPS 390', 'EEPS 391', 'EEPS 481', 'EEPS 495'] },
          ],
          note: 'Any EEPS lecture course at the 300 level or above. The core course not used above may be applied here.',
        },
      ],
    },
    {
      ...
      requirements: [
        {
          ...
          count: 1,
          from: [
            'ECON 480', 'ENGL 269', 'ENGL 310', 'ENGL 358', 'ENGL 459', 'ENST 205', 'ENST 311', 'ENST 313',
        ...
        },
        {
          ...
          count: 1,
          from: [
            'BIOS 280', 'BIOS 326', 'BIOS 329', 'BIOS 334', 'BIOS 374', 'BIOS 559', 'CEVE 302', 'CEVE 308',
            'CEVE 310', 'CEVE 314', 'CEVE 323', 'CEVE 401', 'CEVE 404', 'CEVE 411', 'CEVE 412', 'CEVE 414',
            'CEVE 415', 'CEVE 420', 'CEVE 421', 'CEVE 434', 'CHBE 366', 'CHBE 382', 'CHEM 211', 'EEPS 440',
            'ENST 250', 'ENST 307', 'ENST 406', 'HEAL 372', 'HEAL 375', 'HEAL 376', 'HEAL 407', 'MECH 475',
            'PHYS 101', 'PHYS 102', 'STAT 484', 'STAT 485',
          ],
