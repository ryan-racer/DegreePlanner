...
const DATA_SCIENCE_SYSTEMS = [
  'COMP 330', 'DSCI 302', 'ELEC 378', 'ELEC 406', 'ELEC 430', 'ELEC 431', 'ELEC 434', 'ELEC 436', 'MECH 420', 'ELEC 437',
  'ELEC 439', 'ELEC 447', 'COMP 447', 'ELEC 448', 'ELEC 475', 'ELEC 478', 'ELEC 498', 'COMP 498', 'MECH 498',
  'MECH 488', 'STAT 413',
];
const NEUROENG = [
...
export default {
  ...
  url: 'https://ga.rice.edu/archive/2024-2025/programs-study/departments-programs/engineering/electrical-computer-engineering/electrical-computer-engineering-ba/',
  hours: 62,
  notes: [
  ...
  requirements: [
    ...
    { type: 'any', name: 'Area of Specialization', options: [
      ...
      { type: 'group', name: 'Data Science/Systems', requirements: [
        { type: 'choose', name: 'Data Science/Systems Courses', count: 2, from: DATA_SCIENCE_SYSTEMS },
