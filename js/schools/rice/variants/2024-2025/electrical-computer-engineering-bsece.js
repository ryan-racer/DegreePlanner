// 2024-2025 General Announcements. Areas of specialization that year: Computer Engineering, Data Science/Systems,
// Neuroengineering, and Photonics, Electronics, and Nano-devices.
const COMPUTER_ENG = [
  'COMP 321', 'COMP 382', 'COMP 430', 'ELEC 323', 'COMP 322', 'ELEC 410', 'COMP 436', 'ELEC 411', 'ELEC 414',
  'ELEC 421', 'COMP 421', 'ELEC 422', 'ELEC 423', 'ELEC 424', 'COMP 424', 'ELEC 425', 'COMP 425', 'ELEC 426',
  'ELEC 429', 'COMP 429', 'ELEC 434', 'ELEC 437', 'ELEC 442', 'ELEC 450', 'COMP 450', 'MECH 450',
];
const DATA_SCIENCE_SYSTEMS = [
  'COMP 330', 'DSCI 302', 'ELEC 406', 'ELEC 430', 'ELEC 431', 'ELEC 434', 'ELEC 436', 'MECH 420', 'ELEC 437', 'ELEC 439',
  'ELEC 440', 'COMP 440', 'ELEC 445', 'ELEC 447', 'COMP 447', 'ELEC 448', 'ELEC 475', 'ELEC 478',
  'ELEC 498', 'COMP 498', 'MECH 498', 'MECH 488', 'STAT 413',
];
const NEUROENG = [
  'ELEC 380', 'BIOE 380', 'NEUR 383', 'ELEC 435', 'ELEC 438', 'ELEC 481', 'ELEC 483', 'ELEC 487',
...
const ALL_AREAS = [...COMPUTER_ENG, ...DATA_SCIENCE_SYSTEMS, ...NEUROENG, ...PHOTONICS];

export default {
  id: 'electrical-computer-engineering-bsece',
  name: 'Electrical and Computer Engineering',
  degree: 'BSECE',
  kind: 'major',
  school: 'Engineering and Computing',
  url: 'https://ga.rice.edu/archive/2024-2025/programs-study/departments-programs/engineering/electrical-computer-engineering/electrical-computer-engineering-bsece/',
  hours: 82,
  degreeHours: 125,
  notes: [
    ...
    'At least 14 courses (42 credit hours) must be taken at the 300 level or above.',
  ...
  requirements: [
    { type: 'group', name: 'Core Requirements', requirements: [
      { type: 'group', name: 'Mathematics and Science Courses', requirements: [
        { type: 'all', name: 'Physical Electronics, Random Signals and Calculus', items: ['ELEC 261', 'ELEC 263', 'ELEC 303', ['MATH 101', 'MATH 105'], ['MATH 102', 'MATH 106']] },
        ...
        { type: 'hours', name: 'Approved Electives in Mathematics and Science', hours: 3, from: [
          'BIOS 201', 'CMOR 304', 'CMOR 360', 'CHEM 121', 'CHEM 111', 'CHEM 122', 'CHEM 112',
          'CHEM 123', 'CHEM 113', 'CHEM 124', 'CHEM 114', 'MATH 211', 'MATH 220', 'MATH 222',
        ], note: 'Select 3-4 credit hours from the typically approved courses.' },
      ]},
      { type: 'all', name: 'ECE Core Courses', items: ['ELEC 220', 'ELEC 241', 'ELEC 240', 'ELEC 242', 'ELEC 244', 'ELEC 305', ['ELEC 326', 'COMP 326'], 'ELEC 378'] },
      { type: 'course', name: 'Computation Course', options: ['COMP 140'] },
      { type: 'group', name: 'Design Requirements', requirements: [
        { type: 'course', name: 'Design Laboratory', options: ['ELEC 327', 'ELEC 364'] },
        { type: 'all', name: 'Senior Design', items: ['ELEC 494', 'ELEC 496'] },
      ]},
    ]},
    { type: 'any', name: 'Area of Specialization', options: [
      { type: 'group', name: 'Computer Engineering', requirements: [
        { type: 'choose', name: 'Computer Engineering Courses', count: 3, from: COMPUTER_ENG },
        { type: 'choose', name: 'Course from Another Area', count: 1, from: [...DATA_SCIENCE_SYSTEMS, ...NEUROENG, ...PHOTONICS] },
        { type: 'choose', name: 'Courses from Any Area', count: 2, from: ALL_AREAS },
      ]},
      { type: 'group', name: 'Data Science/Systems', requirements: [
        { type: 'choose', name: 'Data Science/Systems Courses', count: 3, from: DATA_SCIENCE_SYSTEMS },
      ...
      { type: 'group', name: 'Neuroengineering', requirements: [
        { type: 'choose', name: 'Neuroengineering Courses', count: 3, from: NEUROENG },
        { type: 'choose', name: 'Course from Another Area', count: 1, from: [...COMPUTER_ENG, ...DATA_SCIENCE_SYSTEMS, ...PHOTONICS] },
        { type: 'choose', name: 'Courses from Any Area', count: 2, from: ALL_AREAS },
      ]},
      { type: 'group', name: 'Photonics, Electronics, and Nano-devices', requirements: [
        { type: 'choose', name: 'Photonics, Electronics, and Nano-devices Courses', count: 3, from: PHOTONICS },
        { type: 'choose', name: 'Course from Another Area', count: 1, from: [...COMPUTER_ENG, ...DATA_SCIENCE_SYSTEMS, ...NEUROENG] },
        { type: 'choose', name: 'Courses from Any Area', count: 2, from: ALL_AREAS },
      ]},
    ]},
  ],
