...
export default {
  ...
  url: 'https://ga.rice.edu/archive/2025-2026/programs-study/departments-programs/engineering/computer-science/computer-science-bscs/',
  hours: 68,
  notes: [
  ...
  requirements: [
    ...
    { type: 'group', name: 'Breadth Requirements', requirements: [
      { type: 'choose', name: 'Systems', count: 1, from: ['COMP 412', 'COMP 421', 'ELEC 421', 'COMP 422', 'COMP 427', 'COMP 429', 'ELEC 429', 'COMP 432', 'COMP 436', 'ELEC 410', 'COMP 458'] },
      { type: 'choose', name: 'Application Domains', count: 1, from: ['COMP 418', 'COMP 431', 'COMP 440', 'ELEC 440', 'COMP 442', 'COMP 447', 'ELEC 447', 'COMP 450', 'ELEC 450', 'MECH 450', 'COMP 459', 'COMP 462', 'COMP 471', 'COMP 484'] },
      { type: 'choose', name: 'Theory', count: 1, from: ['COMP 409', 'COMP 411', 'COMP 414', 'COMP 423', 'COMP 448', 'MATH 448', 'COMP 463', 'COMP 475', 'COMP 480', 'COMP 481'] },
    ]},
